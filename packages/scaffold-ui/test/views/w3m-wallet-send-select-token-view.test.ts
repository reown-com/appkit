...
import { ChainController, RouterController, SendController, accountState } from '@reown/appkit-core'
...
describe('W3mSendSelectTokenView', () => {
  beforeEach(() => {
    vi.spyOn(accountState, 'tokenBalance', 'get').mockReturnValue(mockTokens)
  ...
  it('should navigate to OnRampProviders on buy click', async () => {
    ...
    vi.spyOn(accountState, 'tokenBalance', 'get').mockReturnValue([])
