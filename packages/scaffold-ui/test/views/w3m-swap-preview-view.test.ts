...
Add test for views/w3m-account-settings-view
Add test for views/w3m-account-view
Add test for views/w3m-all-wallets-view
Add test for views/w3m-approve-transaction-view
Add test for views/w3m-buy-in-progress-view
Add test for views/w3m-choose-account-name-view
Add test for views/w3m-connect-socials-view
Add test for views/w3m-connect-wallets-view
Add test for views/w3m-connecting-external-view
Add test for views/w3m-connecting-farcaster-view
Add test for views/w3m-connecting-multi-chain-view
Add test for views/w3m-connecting-wc-basic-view
Add test for views/w3m-downloads-view
Add test for views/w3m-email-verify-device-view
Add test for views/w3m-email-verify-otp-view
Add test for views/w3m-get-wallet-view
Add test for views/w3m-network-switch-view
Add test for views/w3m-networks-view
Add test for views/w3m-onramp-activity-view
Add test for views/w3m-onramp-fiat-select-view
Add test for views/w3m-onramp-providers-view
Add test for views/w3m-onramp-tokens-select-view
Add test for views/w3m-register-account-name-success-view
Add test for views/w3m-register-account-name-view
Add test for views/w3m-siwx-sign-message-view
Add test for views/w3m-switch-active-chain-view
Add test for views/w3m-switch-address-view
Add test for views/w3m-transactions-view
Add test for views/w3m-unsupported-chain-view
Add test for views/w3m-update-email-primary-otp-view
Add test for views/w3m-update-email-secondary-otp-view
Add test for views/w3m-update-email-wallet-view
Add test for views/w3m-upgrade-wallet-view
Add test for views/w3m-wallet-compatible-networks-view
Add test for views/w3m-wallet-receive-view
Add test for views/w3m-what-is-a-buy-view
Add test for views/w3m-what-is-a-network-view
Add test for views/w3m-what-is-a-wallet-view
