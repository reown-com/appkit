...
describe('W3mSwapInputSkeleton', () => {
  ...
  it('should render shimmer elements', async () => {
    ...
    expect(inputShimmer?.getAttribute('borderRadius')).toBe(null)
    ...
    expect(buttonShimmer?.getAttribute('borderRadius')).toBe(null)
  ...
  it('should render flex containers with correct properties', async () => {
    ...
    expect(inputFlex?.getAttribute('gap')).toBe('1')
    ...
    expect(buttonFlex?.getAttribute('gap')).toBe('1')
  })
})
