...
export * from '../src/views/w3m-transaction-details-view/index.js'
...
export * from '../src/views/w3m-wallet-send-select-view/index.js'
...
export * from '../src/partials/w3m-input-placeholder/index.js'
