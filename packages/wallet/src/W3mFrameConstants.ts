...
export const W3mFrameConstants = {
  ...
  APP_GET_PAYMASTER_TOKENS: '@w3m-app/GET_PAYMASTER_TOKENS',
  ...
  FRAME_GET_PAYMASTER_TOKENS_SUCCESS: '@w3m-frame/GET_PAYMASTER_TOKENS_SUCCESS',
  FRAME_GET_PAYMASTER_TOKENS_ERROR: '@w3m-frame/GET_PAYMASTER_TOKENS_ERROR'
