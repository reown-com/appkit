...
export const SPL_COMPUTE_BUDGET_CONSTANTS = {
  ...
  // Ceiling for the simulate-and-measure call itself; never charged for.
  SIMULATION_UNIT_LIMIT: 1_400_000,
  SIMULATION_MARGIN_MULTIPLIER: 1.3,
  FALLBACK_UNIT_LIMIT_TRANSFER_ONLY: 150000,
  FALLBACK_UNIT_LIMIT_WITH_ATA_CREATION: 200000
} as const
