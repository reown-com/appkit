...
import { EthersHelpersUtil } from '../src/ethers/EthersHelpersUtil'
import { ConstantsUtil } from '../src/ConstantsUtil'
import { PresetsUtil } from '../src/PresetsUtil'
import type { CaipNetwork } from '@reown/appkit-common'
import { ConstantsUtil as CommonConstantsUtil } from '@reown/appkit-common'
import type { Provider } from '../src/ethers/EthersTypesUtil'
...
describe('EthersHelpersUtil', () => {
  ...
  describe('addEthereumChain', () => {
    it('should call wallet_addEthereumChain with correct parameters', async () => {
      const mockProvider = {
      ...
      await EthersHelpersUtil.addEthereumChain(mockProvider, mockChain)
        ...
        params: [
          {
            ...
            iconUrls: [PresetsUtil.NetworkImageIds['137']]
          }
        ]
      })
    })
