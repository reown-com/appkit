export const W3mFrameConstants = {
  ...
  APP_SMART_ACCOUNT_ACTIVATE: '@w3m-app/SMART_ACCOUNT_ACTIVATE',
  ...
  FRAME_SMART_ACCOUNT_ACTIVATE_SUCCESS: '@w3m-frame/SMART_ACCOUNT_ACTIVATE_SUCCESS',
  FRAME_SMART_ACCOUNT_ACTIVATE_ERROR: '@w3m-frame/SMART_ACCOUNT_ACTIVATE_ERROR'
} as const
