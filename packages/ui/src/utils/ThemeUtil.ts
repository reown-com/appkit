...
export function initializeTheming(themeVariables?: ThemeVariables, themeMode?: ThemeType) {
  ...
  experimental.textContent = ThemeHelperUtil.createRooStyles(themeMode)
...
export function setColorTheme(themeMode?: string) {
  if (darkModeTag && lightModeTag && experimental) {
    if (themeMode === 'light') {
      document.head.removeChild(experimental)
      experimental = document.createElement('style')
      experimental.textContent = ThemeHelperUtil.createRooStyles('light')
      document.head.appendChild(experimental)
      ...
      document.head.removeChild(experimental)
      experimental = document.createElement('style')
      experimental.textContent = ThemeHelperUtil.createRooStyles('dark')
      document.head.appendChild(experimental)
