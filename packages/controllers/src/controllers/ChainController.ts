...
// // -- Constants ----------------------------------------- //
// const defaultAccountState: Omit<AccountState, 'caipAddress' | 'address'> = {
//   currentTab: 0,
//   tokenBalance: [],
...
//       ChainController.getSnapshot().context.namespaces.set(namespace, {
//         namespace,
...
//         if (caipNetwork) {
//           ChainController.swithActiveCaipNetwork(caipNetwork)
//         }
//       }
//     }
...
//         ChainController.swithActiveCaipNetwork(chainAdapter.caipNetworks[0])
//       }
...
//     const activeAdapter = ChainController.getSnapshot().context.namespaces.get(namespace)
...
//       const caipNetworks = ChainController.getCaipNetworks(chainAdapter.namespace)
...
//     const requestedCaipNetworks = ChainController.getCaipNetworks(namespace)
...
//       ChainController.getSnapshot().context.namespaces.get(chainToWrite)?.accountState?.preferredAccountType
...
//     return ChainController.getSnapshot().context.namespaces.get(namespace)?.accountState
//   },
...
//     return ChainController.getSnapshot().context.namespaces.get(namespace)?.networkState
//   },
...
//     const chain = ChainController.getSnapshot().context.namespaces.get(chainNamespace)
...
//     return ChainController.getCaipNetworks() ?? []
//   },
