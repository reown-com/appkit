...
export const mockProvider = {
  ...
  namespaces: {
    eip155: {
      ...
      rpcMap: {
        '1': 'https://maksy.ngrok.dev/v1/?chainId=eip155%3A1&projectId=test-project-id'
      }
    },
    solana: {
      ...
      rpcMap: {
        '5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp':
          'https://maksy.ngrok.dev/v1/?chainId=solana%3A5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp&projectId=test-project-id'
      }
    }
  },
