...
export const mockProvider = {
  ...
  namespaces: {
    eip155: {
      ...
      rpcMap: {
        '1': 'https://rpc.walletconnect.org/v1/?chainId=eip155:1&projectId=test-project-id'
      }
    },
    solana: {
      ...
      rpcMap: {
        '5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp':
          'https://rpc.walletconnect.org/v1/?chainId=solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp&projectId=test-project-id'
      }
    }
  },
