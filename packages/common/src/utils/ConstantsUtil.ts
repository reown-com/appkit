  ...
  REMOTE_FEATURES_ALERTS: {
    ...
    HEADLESS_NOT_ENABLED: {
      DEFAULT: {
        displayMessage: '',
        debugMessage:
          'Headless support is not enabled. Please enable it with the enableHeadless option in the AppKit configuration and make sure your you current plan supports it.'
      }
    }
  },
