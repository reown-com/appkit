...
// -- Variables --------------------------------------------------------------
export function getCommonThemeVariables(themeVariables?: ThemeVariables, themeType?: ThemeType) {
  if (themeType === 'dark') {
    return {
  ...
  return {
    ...
    light: css`
      :root {
        ...
        --w3m-accent: ${unsafeCSS(
          getCommonThemeVariables(themeVariables, 'light')['--w3m-accent']
        )};
        --w3m-default: #fff;

        --wui-color-modal-bg-base: ${unsafeCSS(
          getCommonThemeVariables(themeVariables, 'light')['--w3m-background']
        )};
    ...
    dark: css`
      :root {
        ...
        --w3m-accent: ${unsafeCSS(getCommonThemeVariables(themeVariables, 'dark')['--w3m-accent'])};
        --w3m-default: #000;

        --wui-color-modal-bg-base: ${unsafeCSS(
          getCommonThemeVariables(themeVariables, 'dark')['--w3m-background']
        )};
        --wui-color-accent-base-100: var(--w3m-accent);
