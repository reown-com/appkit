...
describe('ConverterUtil', () => {
  describe('convertCaipToErc3770', () => {
    it('should convert Ethereum mainnet CAIP address to ERC-3770 format', () => {
      ...
      const result = ConverterUtil.convertCaipToErc3770(caipAddress)
    ...
    it('should throw error for invalid CAIP format', () => {
      ...
      expect(() => ConverterUtil.convertCaipToErc3770(invalidAddress)).toThrow(
    ...
    it('should throw error for non-EIP155 namespace', () => {
      ...
      expect(() => ConverterUtil.convertCaipToErc3770(nonEip155Address)).toThrow(
    ...
    it('should throw error for unknown chain ID', () => {
      ...
      expect(() => ConverterUtil.convertCaipToErc3770(unknownChainAddress)).toThrow(
    ...
    it('should handle case-insensitive namespace', () => {
      ...
      const result = ConverterUtil.convertCaipToErc3770(mixedCaseAddress)
      expect(result).toBe('eth:0x123456789abcdef123456789abcdef123456789a')
    })
  })
})
