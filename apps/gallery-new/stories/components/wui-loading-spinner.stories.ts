...
import '@reown/appkit-ui-new/src/components/wui-loading-spinner'
import type { WuiLoadingSpinner } from '@reown/appkit-ui-new/src/components/wui-loading-spinner'
