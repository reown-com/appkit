...
import '@reown/appkit-ui-new/src/composites/wui-compatible-network'
import type { WuiCompatibleNetwork } from '@reown/appkit-ui-new/src/composites/wui-compatible-network'
