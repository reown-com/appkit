/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 10a2f871c39b3a8de4bf7801d833ebad)
// Runtime types generated with workerd@1.20250712.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SESSIONID_STORAGE: KVNamespace;
		NEXTJS_ENV: string;
		ASSETS: Fetcher;
	}
}
