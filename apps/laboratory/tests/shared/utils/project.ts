...
const LIBRARIES = ['ethers', 'ethers5', 'wagmi', 'solana', 'bitcoin', 'ton', 'tron'] as const
...
const SINGLE_ADAPTER_TRON_TESTS = ['wallet.spec.ts', 'basic-tests.spec.ts']
...
const SINGLE_ADAPTER_TRON_TESTS_REGEX = createRegex(SINGLE_ADAPTER_TRON_TESTS)
...
const customProjectProperties: CustomProjectProperties = {
  ...
  'Desktop Chrome/tron': {
    testMatch: SINGLE_ADAPTER_TRON_TESTS_REGEX,
    testIgnore:
      /siwe-.*\.spec\.ts|siwx-.*\.spec\.ts|multichain-.*\.spec\.ts|reown-authentication.*\.spec\.ts|multi-wallet.*\.spec\.ts/u
  },
  'Desktop Firefox/tron': {
    testMatch: SINGLE_ADAPTER_TRON_TESTS_REGEX,
    testIgnore:
      /siwe-.*\.spec\.ts|siwx-.*\.spec\.ts|multichain-.*\.spec\.ts|reown-authentication.*\.spec\.ts|multi-wallet.*\.spec\.ts/u
  },
