...
import { DefaultSIWX, CloudAuth, InformalMessenger } from '@reown/appkit-siwx'
...
const informalMessenger = new InformalMessenger({
  ...
  getNonce: () => cloudAuth.getNonce()
})
const siwx = new DefaultSIWX({
  messenger: informalMessenger,
  storage: cloudAuth
})
