            ...
            <Box>
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <Box>
                  ...
                  <Text pt="2" fontSize="sm">
                    Configuration with Ethereum Adapter enabled for AppKit
                  </Text>
                </Box>
                <Link href={'/library/appkit-ethereum-provider'}>
                  <Button rightIcon={<IoArrowForward />}>Go</Button>
                </Link>
              </Stack>
            </Box>
            <Box>
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <Box>
                  ...
                  <Text pt="2" fontSize="sm">
                    Configuration with Universal Adapter enabled for AppKit
                  </Text>
                </Box>
