 ...
 */
const secureSiteDomain = 'https://1347e153.secure-appkit-sdk.pages.dev/sdk'
/*
...
const cspHeader = `
  ...
  frame-src 'self' https://localhost https://192.168.0.196 https://verify.walletconnect.com https://verify.walletconnect.org https://secure.walletconnect.com https://secure.walletconnect.org https://secure.reown.com https://widget.solflare.com/ ${secureSiteDomain};
  object-src 'none';
  base-uri 'self';
  form-action 'self';
