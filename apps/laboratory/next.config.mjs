...
const cspHeader = `
  ...
  frame-src 'self' https://verify.walletconnect.com https://verify.walletconnect.org https://secure.walletconnect.com https://secure.walletconnect.org ${process.env.NEXT_PUBLIC_SECURE_SITE_SDK_URL || ''};
  object-src 'none';
  base-uri 'self';
  form-action 'self';
