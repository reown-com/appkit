...
const cspHeader = `
  ...
  frame-src 'self' https://verify.walletconnect.com https://verify.walletconnect.org https://secure.walletconnect.com https://secure.walletconnect.org https://client.warpcast.com https://warpcast.com;
  object-src 'none';
  base-uri 'self';
  form-action 'self';
