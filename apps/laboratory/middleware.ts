...
export function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    ...
    frame-src 'self' https://verify.walletconnect.com https://verify.walletconnect.org https://secure.walletconnect.com https://secure.walletconnect.org https://secure.reown.com https://secure-appkit-git-feat-appkit-reskin-reown-com.vercel.app ${secureSiteDomain};
    object-src 'none';
    base-uri 'self';
    form-action 'self';
    frame-ancestors ${verifyApiNestedIframesTestOuterDomain} https://app.safe.global https://secure-appkit-git-feat-appkit-reskin-reown-com.vercel.app;
