...
import '@rerock/appkit-ui/src/composites/wui-compatible-network'
import type { WuiCompatibleNetwork } from '@rerock/appkit-ui/src/composites/wui-compatible-network'
