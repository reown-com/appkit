...
import type { WuiTransactionListItemLoader } from '@laughingwhales/appkit-ui/wui-transaction-list-item-loader'
...
export default {
  title: 'Composites/apkt-transaction-list-item-loader'
} as Component
