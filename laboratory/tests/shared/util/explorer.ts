 ...
 */
export async function openWalletFromExplorer(walletName: string, page: Page) {
 ...
 * @param page - playwright page
 */
export async function testWalletMobileView(walletName: string, page: Page) {
 ...
 */
export async function testWalletInstallView(
  walletName: string,
  page: Page,
 ...
 * @param page - playwright page
 */
export async function testWalletDesktopView(
  walletName: string,
  page: Page,
  context: BrowserContext
) {
