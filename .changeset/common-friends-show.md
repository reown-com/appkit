...
'pay-test-exchange': minor
'@reown/appkit-adapter-bitcoin': minor
'@reown/appkit-adapter-ethers': minor
'@reown/appkit-adapter-ethers5': minor
'@reown/appkit-adapter-stellar': minor
'@reown/appkit-adapter-ton': minor
'@reown/appkit-adapter-tron': minor
...
Added support for reading a wallet's address and signing/sending transactions using @solana/kit (the newer Solana SDK), alongside the existing @solana/web3.js support.
