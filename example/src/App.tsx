...
import Web3Modal, { testProviderIsEnabled } from "web3modal";
// @ts-ignore
...
testProviderIsEnabled(window.ethereum).then(res =>
  // tslint:disable-next-line
  console.log("testProviderIsEnabled(window.ethereum)", res)
);
